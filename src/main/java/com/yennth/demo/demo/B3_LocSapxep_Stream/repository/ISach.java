package com.yennth.demo.demo.B3_LocSapxep_Stream.repository;
...
public interface ISach extends JpaRepository<Sach, Integer> {
    ...
    @Query(value = """
            SELECT new com.yennth.demo.demo.B3_LocSapxep_Stream.response.SachRespose(s.ma, s.ten, s.ngayXuatBan, s.soTrang, s.donGia, nxb.ten) 
